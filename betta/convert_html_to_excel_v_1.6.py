...
def chek(table):
    ...
    up = get_tables_with_colspan_and_rowspan(table)
    if vertical_chek(up):
        print("up")
        return True
    
    left = transpose_table_structure( get_tables_with_colspan_and_rowspan(table) )
    if vertical_chek(left):
        print("left")
        return True
    
    right = transpose_table_structure( flip_table_vertical( get_tables_with_colspan_and_rowspan(table) ) )
    if vertical_chek(right):
        print("right")
        return True

    bottom = transpose_table_structure( flip_table_vertical( transpose_table_structure( get_tables_with_colspan_and_rowspan(table) ) ) )
