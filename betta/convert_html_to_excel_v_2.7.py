    ...
    def vertical_check(self):
        ...
        for cell in table_spans[0]:
            old += [{
                             ...
                             'rowspan': cell["rowspan"],
                             'colspan': cell["colspan"],
                             'colspan_original': cell["colspan"],
                             'rowspan_original': cell["rowspan"],
                             'similarity': False
                     }]
            ...
            while k < len(old):
                ...
                if j < len(table_spans[i]):
                    ...
                    if (s + table_spans[i][j]["colspan"]) < old[k]["colspan"]:
                        ...
                        new += [{
                                 "value": table_spans[i][j]["value"],
                                 "rowspan": table_spans[i][j]["rowspan"],
                                 "colspan": table_spans[i][j]["colspan"],
                                 "rowspan_original": table_spans[i][j]["rowspan"],
                                 "colspan_original": table_spans[i][j]["colspan"],
                                 "similarity": False
                                 }]
                        j += 1
                        continue
                        ...
                        if s == 0:
                            ...
                            if old[k]["similarity"]:
                                ...
                                if not (old_structure == new_structure):
                                    return False
                        s = 0
                        new += [{"value": table_spans[i][j]["value"],
                                 "rowspan": table_spans[i][j]["rowspan"],
                                 "colspan": table_spans[i][j]["colspan"],
                                 "rowspan_original": table_spans[i][j]["rowspan"],
                                 "colspan_original": table_spans[i][j]["colspan"],
...
if __name__ == "__main__":
    ...
    if genuine_tables:
        ...
        print('подлинных таблиц не найдено')
