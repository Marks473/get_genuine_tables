...
def get_tag_structure(element):  # Добавлен self как первый параметр
        ...
        for child in element.children:
            ...
            child_structure = get_tag_structure(child)  # Исправлено: добавлен self
            if child_structure:
...
class SpanTable:
    ...
    def make_table(self, table):
        """Получение таблицы с шириной и длиной ячейки"""
        table_span = []
    ...
    def vertical_chek(self):
        """Проверка на подлиность вертикальных таблиц"""
        
        table_spans = self.get_table()
    ...
    def is_top(self):
        return self.get_copy().vertical_chek()

    def is_left(self):
        table_span = self.get_copy().get_transpose()
        return table_span.vertical_chek()
    def is_right(self):
        table_span = self.get_copy().get_transpose().get_flip()
        return table_span.vertical_chek()
    def is_bottom(self):
        table_span = self.get_copy().get_transpose().get_flip().get_transpose()
        return table_span.vertical_chek()
